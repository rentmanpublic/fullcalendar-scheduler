...
CalendarExtension = (function(superClass) {
  ...
  CalendarExtension.prototype.removeAllResources = function() {
    return this.resourceManager.removeAllResources();
  };
...
ResourceManager = (function(superClass) {
  ...
  ResourceManager.prototype.removeAllResources = function() {
    this.topLevelResources = [];
    this.resourcesById = {};

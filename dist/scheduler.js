/*!
 * Rentman FullCalendar Scheduler v1.9.5
...
var TimelineEventRenderer = /** @class */ (function (_super) {
    ...
    */
    ...
    TimelineEventRenderer.prototype.renderFgSegs = function (segs) {
        ...
        var containerParentEl = this.component.segContainerEl.parent();
    ...
    TimelineEventRenderer.prototype.unrenderFgSegs = function (segs) {
        if (this.component.segContainerEl) { // rendered before?
            ...
            var parentEl = this.component.segContainerEl.parent();
            var fragment = document.createDocumentFragment();
            fragment.appendChild(this.component.segContainerEl[0]);
    ...
    TimelineEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        var props = eventDef.miscProps;
        var icons = (props.icon ? [props.icon] : props.icons) || [];
        var iconTemplate = '';
...
var RowParent = /** @class */ (function (_super) {
    ...
    */
    RowParent.prototype.setTrInnerHeight = function (height) {
        // exclude multi-rowspans (probably done for row grouping)
        $.each(this.trHash, function (type, tr) {
            var elem = util_1.getOwnCells(tr).find('> div:not(.fc-cell-content):first');
...
var ScrollFollower = /** @class */ (function () {
    ...
    */
    ...
    ScrollFollower.prototype.cacheDimensions = function () {
        ...
        var rects = {};
        this.iterSprites(function (sprite, id) { return rects[id] = sprite.getRects(); });
        this.iterSprites(function (sprite, id) {
            var spriteRects = rects[id];
...
var ScrollFollowerSprite = /** @class */ (function () {
    ...
    */
    ...
    ScrollFollowerSprite.prototype.getRects = function () {
        var rects = {};
    ...
    ScrollFollowerSprite.prototype.cacheDimensions = function (naturalRect, parentRect, containerRect) {
...
var ResourceRow = /** @class */ (function (_super) {
    ...
    function ResourceRow(view, resource) {
        ...
        var isExpanded = _this.view.publiclyTrigger('resourceInitiallyExpanded', {
            context: resource,
            args: [resource, _this.view]
        });
...
var moment = __webpack_require__(15);
var exportHooks = __webpack_require__(0);
var RELEASE_DATE = '2018-10-23'; // for Scheduler
